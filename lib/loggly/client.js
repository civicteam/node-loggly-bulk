...
// common.flush will be replaced once the logger is used for the first time
// so making this a thunk ensures the new version of flush is always used
Loggly.prototype.flush = () => common.flush();
