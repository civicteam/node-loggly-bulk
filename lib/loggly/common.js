...
// async no-op that will be replaced as soon as a single message has been sent to the log() function
common.flush = () => Promise.resolve();
...
//
  ...
  common.flush = sendBufferdLogstoLoggly;
};
